/**
 * Created by mingyang on 18/1/25.
 */
/*!
...
;(function(root, factory) {
    ...
    var o = {
        sTag: '<%',//寮€濮嬫爣绛�
        eTag: '%>',//缁撴潫鏍囩
        compress: false,//鏄惁鍘嬬缉html
        escape: true, //榛樿杈撳嚭鏄惁杩涜HTML杞箟
        error: function (e) {}//閿欒鍥炶皟
    };
    var functionMap = {}; //鍐呴儴鍑芥暟瀵硅薄
    //淇グ鍣ㄥ墠缂€
    var modifierMap = {
    ...
    function compiler(tpl, opt) {
        ...
        code = code.replace(/[\r]/g, ' '); // ie 7 8 浼氭姤閿欙紝涓嶇煡閬撲负浠€涔�
        try {
